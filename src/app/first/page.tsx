          ...
          .on('broadcast', { event: 'order_accepted' }, (payload) => {
            if (payload.payload.order_id === order.order_id) {
              ...
              const activeTripData = {
                ...
                free_on_way_km: parseFloat(order.free_on_way_km || '0'),
                free_waiting_min: parseFloat(order.free_waiting_min || '0'),
                on_way_cost: 0,
                waiting_cost: 0,
                trip_cost: 0,
      ...
      .on('broadcast', { event: 'trip_created' }, (payload: any) => {
        ...
        if (payload.payload.customer_id === userId) {
          ...
          const tripData = {
            ...
            free_on_way_km: payload.payload.free_on_way_km,
            free_waiting_min: payload.payload.free_waiting_min,
            on_way_cost: 0,
            waiting_cost: 0,
            trip_cost: 0,
